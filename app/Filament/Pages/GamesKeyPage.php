        ...
        return $form
            ->schema([
                ...
                Section::make('Drakon API')
                    ->description('Credenciais para integração com a API Drakon')
                    ->schema([
                        TextInput::make('drakon_agent_code')
                            ->label('Drakon Agent Code')
                            ->placeholder('Digite aqui o Agent Code para Drakon')
                            ->maxLength(191),
                        TextInput::make('drakon_agent_token')
                            ->label('Drakon Agent Token')
                            ->placeholder('Digite aqui o Agent Token para Drakon')
                            ->maxLength(191),
                        TextInput::make('drakon_agent_secret')
                            ->label('Drakon Agent Secret')
                            ->placeholder('Digite aqui o Agent Secret para Drakon')
                            ->maxLength(191),
                    ])
                    ->columns(3),
            ])
